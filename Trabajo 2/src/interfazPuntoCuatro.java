...
public class interfazPuntoCuatro extends Container implements ActionListener {


    JComboBox ciudad;

    public interfazPuntoCuatro() throws SQLException{
        setSize(500, 500);
    ...
    public void actionPerformed(final ActionEvent e) {
        ...
        if (e.getActionCommand().equals("Graficar")) {
            ...
            solucionPuntoCuatro.recibirCiudad(ciudad.getSelectedItem().toString());            
